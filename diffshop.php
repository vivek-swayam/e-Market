...
<html lang="en">
  ...
  <head>
    ...
    <style>
      img{width: 200px; height:200px; margin-top: 30px; margin-left: 29px; }
    </style> 
  ...
  <div class="row">
        ...
        <font size="6" style="margin-left: -142px;color: white;font-family:Forte;">e-market</font>
            <div id="custom-search-input">
                                <form method="post" action="diffshopnext.php">
                ...
                <div class="input-group col-md-12" style="margin-top: -46px; margin-left: 12px;">
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-info btn-lg" style="margin-left:0px" type="submit"></form>
     ...
     while($row =mysqli_fetch_array($result)) 
         {
          ...
          <div style='margin-left:85px;'><input type='submit' value='".$row['sh_name']."'/></div>
          </form></div>";
