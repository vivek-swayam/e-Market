...
$query="select * from orders where cu_id='$p' and pr_id='$q' and sh_id='$r'";
  $result=mysqli_query($dbc,$query);
  $num=mysqli_num_rows($result); 

if($num==0)
{
$abc="insert into orders set cu_id='$p' ,sh_id='$r',pr_id='$q',or_billamount='$t',or_status='0',or_quant='$S'";
...
$S=$rows['or_quant']+$S;
$t=$S*$_POST['prcost'];
$abc="update orders set or_quant='$S' where cu_id='$p' and pr_id='$q' and sh_id='$r'";
$result=mysqli_query($dbc,$abc);
$abc="update orders set or_billamount='$t' where cu_id='$p' and pr_id='$q' and sh_id='$r'";
$result=mysqli_query($dbc,$abc);
}
$y=0;
     ...
     while($row =mysqli_fetch_array($result)) 
      ...
      <div class='col-md-11' style='font-size:20px; margin-left:800px; margin-top:-115px;'>
          <form method='post' action='delete.php'>
              ...
              <input type='hidden' value='".$r."' name='l'/>
